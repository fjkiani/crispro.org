import { type GeneFromSearch, type GeneBounds, type GeneDetailsFromSearch } from "~/utils/genome-api";
            ...
            <CardContent className="pb-4">
                <div className="grid gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                        <div className="flex">
                            <span className="w-28 min-28 text-xs text-[#3c4f3d]/70">
                                Symbol:
                            </span>
                        ...
                        {gene.gene_id && (
                            <div className="flex">
                                ...
                                <span className="text-xs"> 
                                    ...
                                    >
                                        {gene.gene_id}
                                        <ExternalLink className="ml-1 inline-block h-3 w-2"></ExternalLink>
                                    </a>
                                </span>
