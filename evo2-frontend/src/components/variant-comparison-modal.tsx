...
import { Check, ExternalLink, Shield, X, type Ghost } from "lucide-react";
import { getClassificationColorClasses, getNucleotideColorClass, getRiskColorClasses } from "~/utils/coloring-utils";
            ...
            <div className="max-h-[90vh] w-full max-w-3xl overflow-y-auto rounded-lg bg-white">
                ...
                <div className="p-5">
                    {comparisonVariant && comparisonVariant.evo2Result && (
                        <div className="space-y-6">
                            <div className="rounded-md border-[#3c4f3d]/10 bg-[#e9eeea]/30 p-4">
                                ...
                                <div className="grid gap-4 md:grid-cols-2">
                                    <div>
                                        <div className="space-y-2">
                                            <div className="flex">
                                                <span className="text-xs w-28 text-[#3c4f3d]/70">
                                                    Position:
                                                </span>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex items-center">
                                                ...
                                                <a
                                                    ...
                                                    className="text-xs text-[#de8246] hover_underline"
                                                    target="_blank"
                                                >
                                                    {comparisonVariant.clinvar_id}
                                                </a>
                                                <ExternalLink className="ml-1 inline-block h-2 w-2 text-[#de8246]"/>
                                        </div>
                                    </div>
                                ...
                                <div className="rounded-md border border-[#3c4f3d]/10 bg-white p-4">
                                    <div className="grid gap-4 md:grid-cols-2">
                                        <div className="rounded-md bg-[#e9eeea]/50 p-4">
                                            <h5 className="mb-2 flex items-center gap-2 text-xs font-medium text-[#3c4f3d]">
                                                <span className="flex h-5 w-5 items-center justify-center rounded-full bg-[#3c4f3d]/10">
                                                    <span className="w-3 h-3 rounded-full bg-[#3c4f3d]">
                                        ...
                                        <div className="rounded-md bg-[#e9eeea]/50 p-4">
                                            <h5 className="mb-2 flex items-center gap-2 text-xs font-medium text-[#3c4f3d]">
                                                <span className="flex h-5 w-5 items-center justify-center rounded-full bg-[#3c4f3d]/10">
                                                    <span className="w-3 h-3 rounded-full bg-[#de8246]">
                                            ...
                                            <div className="mt-3">
                                                ...
                                                <div className="mt-3">
                                                    ...
                                                    <div className={`inline-block rounded-lg px-3 py-1 text-xs ${getRiskColorClasses(comparisonVariant.evo2Result.splice_risk)}`}>
                                                        {comparisonVariant.evo2Result.splice_risk}
                                                    </div>
                                                    {comparisonVariant.evo2Result.splice_position && comparisonVariant.evo2Result.splice_boundary && (
                                                        <div className="text-xs text-[#3c4f3d]/60">
                                                            Variant is {comparisonVariant.evo2Result.splice_position == parseInt(comparisonVariant.location.replaceAll(",", ""))
                                                                ? `at the ${comparisonVariant.evo2Result.splice_boundary}`
                                                                : `${Math.abs(comparisonVariant.evo2Result.splice_position - parseInt(comparisonVariant.location.replaceAll(",", "")))} bp 
                                                                ${comparisonVariant.evo2Result.splice_position < parseInt(comparisonVariant.location.replaceAll(",", "")) ? "downstream":"upstream"}   
                                                                from ${comparisonVariant.evo2Result.splice_boundary} `
                                                            } of an exonic region
                                                        </div>
                                                    )}
                                                </div> 
                ...
                <div className="flex justify-end border-t border-[#3c4f3d]/10 bg-[#e9eeea]/30 p-4">
                    <Button
                        variant="outline"
                        onClick={onClose}
                        className="cursor-pointer border-[#3c4f3d]/10 bg-white text-[#3c4f3d] hover:bg-[#e9eea]/70"
                    >
                        Close
                    </Button>
                </div>
