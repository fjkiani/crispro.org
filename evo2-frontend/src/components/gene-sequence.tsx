        ...
        for (let i = 0; i < sequenceData.length; i+=BASES_PER_LINE) {
            ...
            lines.push(
                <div key={i} className="flex">
                    <div className="mr-2 w-20 text-rught text-gray-500 select-none">
        ...
        <Card className="gap-0 border-none bg-white py-0 shadow-sm">
            ...
            <CardContent className="pb-4">
                        ...
                        <div className="space-y-4">
                            <div className="relative">
                                ...
                                >
                                    ...
                                    <div 
                                        className="absolute top-1/2 flex h-6 w-6 -translate-x-1/2 -translate-y-1/2 cursor-grab itemrs-center justify-center rounded-full border-2 border-[#3c4f3d] bg-white shadow active:cursor-grabbing"
                            ...
                            <div className="flex flex-col space-y-4 sm:flex-row sm:items-center sm:justify-between sm:space-y-0">
                                <div className="flex items-center gap-2">
                                    ...
                                    <Input 
                                        ...
                                        inputMode="numeric"
                                        pattern="[0-9]*"
                                        className="h-7 w-4 border-[#3c4f3d]/10 text-xs sm:w-28"
                                    /> 
                                </div>
                                <Button
                                    size='sm'
                                    ...
                                    className="h-7 w-full cursor-pointer bg-[#3c4f3d] text-xs text-white hover:bg-[#3c4f3d]/90 w-auto"
                                >
                ...
                <div className="mb-2 flex items-center justify-between text-xs">
                    ...
                    <span className="text-[#3c4f3d]/70">
                        Maximum window size: {maxViewRange.toLocaleString()}
                    </span>
                </div>
                ...
                <div className="w-full rounded-md bg-[#e9eeea]/50 p-3">
                    {isLoading ? (
                        ...
                        <div className="h-64 overflow-x-auto overflox-y-auto"> 
