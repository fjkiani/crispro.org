...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_PANEL_ANALYSIS_BASE_URL: z.string(),
    NEXT_PUBLIC_COPILOT_BASE_URL: z.string(),
  },
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_PANEL_ANALYSIS_BASE_URL: process.env.NEXT_PUBLIC_PANEL_ANALYSIS_BASE_URL,
