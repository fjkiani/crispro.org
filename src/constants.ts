...
export const PRODUCTS: Capability[] = [
  ...
  },
  {
    ...
    subtitle: 'Optional Deep Research with your Gemini key',
    tag: 'All Cancers · Synthesis',
    desc: 'Ask a question; Evidence searches PubMed and related portals, synthesizes mechanisms, and optionally runs Deep Research (BM25 + map–reduce + Zeta-Core directive). Deep mode requires your Google Gemini API key per request — never stored.',
    status: 'BETA',
    link: '/research-intelligence',
    gradient: 'from-indigo-500 to-violet-600',
    stats: [
      { value: 'PubMed', label: 'Portals' },
      { value: 'Opt-in', label: 'Deep' },
      { value: 'Your key', label: 'Gemini' },
      { value: 'JSON', label: 'Contract' },
    ],
    features: [
      'Baseline synthesis on server keys',
      'Deep Research: bring your Gemini API key (HTTPS only)',
      'Copy full JSON context for audit trails',
      'MOAT + trials + drug interaction hooks',
    ],
    ctaLabel: 'Open Research Intel',
  },
  {
    icon: '🧪',
